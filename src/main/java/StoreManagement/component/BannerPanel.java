...
public class BannerPanel extends JPanel {
    ...
    public BannerPanel() {
        ...
        // test load image from assets but not in stable
        ImageIcon originalIcon = new ImageIcon(getClass().getResource("/StoreManagement/assets/img/CuaHangImage2.png"));
        try {
            Image image = ImageIO.read(getClass().getResourceAsStream("/StoreManagement/assets/img/CuaHangImage2.png"));
        ...
        textLabel.setFont(FontLoader.load("StoreManagement/assets/Fonts/AmaticSC-Regular.ttf", 70f));
        textLabel.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel textLabel2 = new JLabel("FIND THE PERFECT COFFEE                        ");
        textLabel2.setForeground(Color.BLACK);
        textLabel2.setFont(FontLoader.load("StoreManagement/assets/Fonts/DancingScript-Regular.ttf", 25f));
        ...
        textLabel3.setFont(FontLoader.load("StoreManagement/assets/Fonts/DancingScript-Regular.ttf", 20f));
        ...
        textLabel4.setFont(FontLoader.load("StoreManagement/assets/Fonts/DancingScript-Regular.ttf", 20f));
        ...
        textLabel5.setFont(FontLoader.load("StoreManagement/assets/Fonts/DancingScript-Regular.ttf", 20f));
