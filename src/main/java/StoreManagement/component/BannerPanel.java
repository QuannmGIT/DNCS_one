...
public class BannerPanel extends JPanel {
    ...
    public BannerPanel() {
        ...
        ImageIcon originalIcon = new ImageIcon(getClass().getResource("/assets/img/CuaHangImage2.png"));
        try {
            BufferedImage im = ImageIO.read(getClass().getResourceAsStream("/assets/img/CuaHangImage2.png"));
            Image image = im;
        } catch (IOException e) {
...
//        Image image = originalIcon.getImage();
        ...
        textLabel.setFont(FontLoader.load("assets/Fonts/AmaticSC-Regular.ttf", 70f));
        textLabel.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel textLabel2 = new JLabel("FIND THE PERFECT COFFEE                        ");
        textLabel2.setForeground(Color.BLACK);
        textLabel2.setFont(FontLoader.load("assets/Fonts/DancingScript-Regular.ttf", 25f));
        ...
        textLabel3.setFont(FontLoader.load("assets/Fonts/DancingScript-Regular.ttf", 20f));
        ...
        textLabel4.setFont(FontLoader.load("assets/Fonts/DancingScript-Regular.ttf", 20f));
        ...
        textLabel5.setFont(FontLoader.load("assets/Fonts/DancingScript-Regular.ttf", 20f));
