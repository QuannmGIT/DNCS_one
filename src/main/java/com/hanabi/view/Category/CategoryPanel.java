...
public class CategoryPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        menuIcon = new FlatSVGIcon("com/hanabi/resources/StoreManagement/assets/icon/MenuIcon.svg", 22, 22);
        menuIconLight = new FlatSVGIcon("com/hanabi/resources/StoreManagement/assets/icon/MenuIconLight.svg", 22, 22);
        accountIcon = new FlatSVGIcon("com/hanabi/resources/StoreManagement/assets/icon/AccountIcon.svg", 22, 22);
        accountIconLight = new FlatSVGIcon("com/hanabi/resources/StoreManagement/assets/icon/AccountIconLight.svg", 22, 22);
        revenueIcon = new FlatSVGIcon("com/hanabi/resources/StoreManagement/assets/icon/RevenueIcon.svg", 22, 22);
        revenueIconLight = new FlatSVGIcon("com/hanabi/resources/StoreManagement/assets/icon/RevenueIconLight.svg", 22, 22);
    ...
    private void onMenuItems(ActionEvent evt) {
        setActivePage(PAGE_MENU_ITEMS);
        if (onNavigate != null) onNavigate.accept(PAGE_MENU_ITEMS);
    }

    private void onAccounts(ActionEvent evt) {
        setActivePage(PAGE_ACCOUNTS);
        if (onNavigate != null) onNavigate.accept(PAGE_ACCOUNTS);
    }

    private void onRevenue(ActionEvent evt) {
        setActivePage(PAGE_REVENUE);
        if (onNavigate != null) onNavigate.accept(PAGE_REVENUE);
    }
