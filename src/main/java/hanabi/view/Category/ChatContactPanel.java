...
public class ChatContactPanel extends JPanel {
    ...
    public static class ContactData {
        ...
        public ContactData(UUID id, String name, String lastMessage, String lastTime, int unreadCount) {
            this.id = id;
            this.name = name;
    ...
    private final BiConsumer<UUID, String> onContactSelected;
    private JPanel selectedItem;

    public ChatContactPanel(List<ContactData> contacts,
            BiConsumer<UUID, String> onContactSelected) {
    ...
    public void populateContacts(List<ContactData> contacts) {
    ...
    private JPanel createContactItem(ContactData contact) {
        JPanel item = new JPanel(new MigLayout("insets 10 20 10 15, fillx", "[fill, grow][]")) {
            @Override
            public Dimension getPreferredSize() {
                Dimension d = super.getPreferredSize();
                d.width = Math.min(d.width,
                        getParent() != null ? getParent().getWidth() : 300);
                return d;
            }
        };
        ...
        item.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                ...
                if (onContactSelected != null) {
                    onContactSelected.accept(contact.id, contact.name);
                }
            }
